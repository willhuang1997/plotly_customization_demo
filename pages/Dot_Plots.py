...
try:
    st.expander("See code").code(inspect.getsource(get_chart_3836))
    get_chart_3836()
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_34159))
    get_chart_34159()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_7093))
    get_chart_7093()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_46977))
    get_chart_46977()
except Exception as e:
    st.exception(e)
