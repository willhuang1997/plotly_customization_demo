...
try:
    st.expander("See code").code(inspect.getsource(get_chart_32805))
    get_chart_32805()
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_36493))
    get_chart_36493()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_87088))
    get_chart_87088()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_32534))
    get_chart_32534()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_5008))
    get_chart_5008()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_90639))
    get_chart_90639()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_87291))
    get_chart_87291()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_22635))
    get_chart_22635()
except Exception as e:
    st.exception(e)
