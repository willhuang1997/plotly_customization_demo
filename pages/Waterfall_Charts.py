...
try:
    st.expander("See code").code(inspect.getsource(get_chart_56268))
    get_chart_56268()
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_42452))
    get_chart_42452()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_39807))
    get_chart_39807()
except Exception as e:
    st.exception(e)
