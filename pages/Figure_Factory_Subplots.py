...
try:
    st.expander("See code").code(inspect.getsource(get_chart_24223))
    get_chart_24223()
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_78026))
    get_chart_78026()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_43887))
    get_chart_43887()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_64747))
    get_chart_64747()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_80769))
    get_chart_80769()
except Exception as e:
    st.exception(e)
