...
try:
    st.expander("See code").code(inspect.getsource(get_chart_27087))
    get_chart_27087()
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_5386))
    get_chart_5386()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_84626))
    get_chart_84626()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_53917))
    get_chart_53917()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_91549))
    get_chart_91549()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_40393))
    get_chart_40393()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_13976))
    get_chart_13976()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_99073))
    get_chart_99073()
except Exception as e:
    st.exception(e)
