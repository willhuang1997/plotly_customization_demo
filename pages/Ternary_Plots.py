...
try:
    st.expander("See code").code(inspect.getsource(get_chart_50516))
    get_chart_50516()
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_21157))
    get_chart_21157()
except Exception as e:
    st.exception(e)
...
try:
    st.expander("See code").code(inspect.getsource(get_chart_41500))
    get_chart_41500()
except Exception as e:
    st.exception(e)
