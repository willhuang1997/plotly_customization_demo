...
st.title("3rd party charting libraries with Streamlit theme")
st.text("This is a demo app showing how various charting libraries look with Streamlit styling.")
...
st.plotly_chart(fig11, use_container_width=True, theme="streamlit")
...
fig20 = px.density_heatmap(df, x="total_bill", y="tip", color_continuous_scale="Viridis")
